...
public class MoThresholdController {
     ...
     */
    @PostMapping
    public PublicResult<String> addMokpi(@ValidationParam("moThType,moThDown,resStypeId,moKpiId,moAbnormald,showorder")
     ...
     */
    @PutMapping
    public PublicResult<String> updateMokpi(@ValidationParam("moThType,moThId,moThDown,resStypeId,moKpiId,moAbnormald,showorder")
                                            @RequestBody JSONObject requestJson) throws Exception {
        MoThreshold moThreshold = requestJson.toJavaObject(MoThreshold.class);
